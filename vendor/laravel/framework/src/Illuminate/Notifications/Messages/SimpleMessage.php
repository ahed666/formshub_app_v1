...
class SimpleMessage
{
    ...
    /**
     * The unsubscribe action URL.
     *
     * @var string
     */
    public $unsubscribeActionUrl;

    /**
    * The unsubscribe action text.
    *
    * @var string
    */
   public $unsubscribeActionText;
    ...
    /**
     * Configure the "call to unsubscribe action" link.
     *
     * @param  string  $text
     * @param  string  $url
     * @return $this
     */
    public function unsubscribeAction($unsubscribetext, $unsubscribeurl)
    {

        $this->unsubscribeActionText = $unsubscribetext;
        $this->unsubscribeActionUrl = $unsubscribeurl;
    ...
    public function toArray()
    {
        return [
            ...
            'unsubscribeActionText' => $this->unsubscribeActionText,
            'unsubscribeActionUrl' => $this->unsubscribeActionUrl,
