    ...
    public function message()
    {
        ...
        switch (true) {
            ...
            case $this->requireUppercase
                ...
                &&  $this->requireLowercase
                && $this->requireSpecialCharacter:
                return __('The :attribute must be at least :length characters and contain at least one uppercase character ,one lowercase, one number, and one special character.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                ...
                &&   $this->requireUppercase
                &&  $this->requireLowercase:
                return __('The :attribute must be at least :length characters and contain at least one uppercase character ,one lowercase,and one number.', [
                    'length' => $this->length,
                ]);
                case !$this->requireNumeric
                && $this->requireSpecialCharacter
                &&   $this->requireUppercase
                &&  $this->requireLowercase:
                return __('The :attribute must be at least :length characters and contain at least one uppercase character ,one lowercase, and one special character.', [
                    'length' => $this->length,
                ]);
                case !$this->requireNumeric
                && !$this->requireSpecialCharacter
                &&   $this->requireUppercase
                &&  $this->requireLowercase:
                return __('The :attribute must be at least :length characters and contain at least one uppercase character ,and one lowercase.', [
                    'length' => $this->length,
                ]);
                case $this->requireNumeric
                && $this->requireSpecialCharacter
                ...
                &&  !$this->requireUppercase
                &&  $this->requireLowercase:
                return __('The :attribute must be at least :length characters and contain at least one lower character,and one number', [
                    'length' => $this->length,
                ]);
                case !$this->requireNumeric
                && $this->requireSpecialCharacter
                &&  !$this->requireUppercase
                &&  $this->requireLowercase:
                return __('The :attribute must be at least :length characters and contain at least one lower character,and one special character', [
                    'length' => $this->length,
                ]);
                case !$this->requireNumeric
                && !$this->requireSpecialCharacter
                &&  !$this->requireUppercase
                &&  $this->requireLowercase:
                return __('The :attribute must be at least :length characters and contain at least one lower character', [
                    'length' => $this->length,
                ]);
            default:
