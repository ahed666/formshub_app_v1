...
class Features
{
     ...
     * @return bool
     */
    public static function sendsAccountInvitations()
    {
        return static::optionEnabled(static::accounts(), 'invitations');
    }
    ...
    /**
     * Enable the accounts feature.
     *
     * @param  array  $options
     * @return string
     */
    public static function accounts(array $options = [])
    {
        if (! empty($options)) {
            config(['jetstream-options.accounts' => $options]);
        }
