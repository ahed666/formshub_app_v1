...
class Jetstream
{
    ...
    /**
     * The account model that should be used by Jetstream.
     *
     * @var string
     */
    ...
    /**
     * The account invitation model that should be used by Jetstream.
     *
     * @var string
     */
    public static $accountInvitationModel = 'App\\Models\\AccountInvitation';
    ...
    /**
     * Determine if Jetstream is supporting account features.
     *
     * @return bool
     */
    public static function hasAccountFeatures()
    {
        return Features::hasAccountFeatures();
    }
     ...
     * @return bool
     */
    public static function userHasAccountFeatures($user)
    {
    ...
    /**
     * Specify the account model that should be used by Jetstream.
     *
     * @param  string  $model
     * @return static
     */
    ...
    /**
     * Get the name of the account invitation model used by the application.
     *
     * @return string
     */
    public static function accountInvitationModel()
    {
        return static::$accountInvitationModel;
    }

    /**
     * Specify the account invitation model that should be used by Jetstream.
     *
     * @param  string  $model
     * @return static
     */
    public static function useAccountInvitationModel(string $model)
    {
    ...
    {
        return app()->singleton(CreatesAccounts::class, $class);
    }

    /**
     * Register a class / callback that should be used to update account names.
     *
     * @param  string  $class
     * @return void
     */
    public static function updateAccountNamesUsing(string $class)
    {
        return app()->singleton(UpdatesAccountNames::class, $class);
    }

    /**
     * Register a class / callback that should be used to add account members.
     *
     * @param  string  $class
     * @return void
     */
    public static function addAccountMembersUsing(string $class)
    {
        return app()->singleton(AddsAccountMembers::class, $class);
    }
     ...
     * @return void
     */
    public static function inviteAccountMembersUsing(string $class)
    {
        return app()->singleton(InvitesAccountMembers::class, $class);
    }

    /**
     * Register a class / callback that should be used to remove account members.
     *
     * @param  string  $class
     * @return void
     */
    public static function removeAccountMembersUsing(string $class)
    {
        return app()->singleton(RemovesAccountMembers::class, $class);
    }
