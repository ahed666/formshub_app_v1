...
const confirmingLeavingAccount = ref(false);
...
const confirmLeavingTeam = () => {
    confirmingLeavingAccount.value = true;
};
...
<template>
    <div>
        ...
        <ConfirmationModal :show="confirmingLeavingAccount" @close="confirmingLeavingAccount = false">
            <template #title>
                Leave Team
            </template>
            ...
            <template #footer>
                <SecondaryButton @click="confirmingLeavingAccount = false">
                    Cancel
                </SecondaryButton>
