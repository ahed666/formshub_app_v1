...
<div  class="flex justify-between items-center  text-sm mb-1 w-full h-[10px] max-h-[10px] min-h-[10px] ">
    <span class="text-sm">{{ __('main.question') }}</span>
...
<textarea placeholder="{{ $hint }}" maxlength="255" value="{{ $text }}"  rows="3" cols="90" class="text-2xl xs:text-sm resize-none text-center shadow-none	focus:shadow-none	 border-none outline-none  w-full focus:outline-none focus:border-none
