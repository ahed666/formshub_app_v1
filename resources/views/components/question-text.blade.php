...
<div  class="flex justify-center space-x-6 items-center  text-sm mb-1 w-full h-[10px] max-h-[10px] min-h-[10px] ">
     <div>
...
" required autofocus min="10" minlength="10" wire:model.defer="question_text" pattern=".*\S+.*" title="Input cannot contain only spaces." name="" id="questionText" required ></textarea>
</div>
</div>
<script>
