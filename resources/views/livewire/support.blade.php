...
<div class="mt-2">
    <div class="min-h-[20%] max-h-[20%] border border-gray-200 bg-white mb-1 rounded-[0.5rem] p-4 ">
        ...
        <div class="mt-1 flex justify-start items-center">
            <a href="{{ route('knowledgebase') }}" target="_blank" class="rounded bg-gray-300 p-2 text-secondary_blue hover:text-secondary_1 hover:no-underline focus:outline-none active:outline-none">
                {{ __('main.visit_kb') }}
            </a>
        </div>
        <div class="mt-8">
