                    ...
                    @foreach ($answers as $i =>  $answer )
                        ...
                        <div id="list{{ $i }}" class="   p-1  col-span-3 border-[1px] border-gray-300 rounded-lg" >
                            ...
                            <div class="border-[1px] border-gray-300 p-[2px] rounded-lg w-[100px] h-[100px] ">
                                <img id="answerimage-image{{ $i }}" wire:ignore  wire:model.defer="answers.{{$i}}.image" class="w-full h-full object-contain block ml-auto mr-auto"
                                    ...
                                    <input onchange="uploadImageEdit(event,{{ $i }},'edit')"   class="image opacity-0 absolute -z-10" type="file" name="image{{ $i }}" id="image{{ $i }}" accept="image/*" /></label>
                            </div>
                            </div>
                ...
                {{-- add image section --}}
                    <div class=" mt-2 flex justify-center  " >
                        <div class="border-[1px] border-gray-300 p-[2px] rounded-lg w-[150px] h-[150px] ">
                            <img id="answerimage-image0" wire:ignore  wire:model="{{ asset($question_image_temp)}}" class="w-full h-full object-contain block ml-auto mr-auto"
                            @if(str_contains($question_image_temp, 'data:image'))
                            src="{{ $question_image_temp}}"
                            @else
                            src="{{ asset($question_image_temp)}}"
                            @endif
                                alt="">
                                ...
                                <input   onchange="uploadImageAdd(event,'0','edit')" class="image opacity-0 absolute -z-10" type="file" name="image" id="image" accept="image/*" /></label>
                        </div>
                    </div>
                {{-- end add image section --}}
...
<script>
    function uploadImageEdit(event,index,type){
