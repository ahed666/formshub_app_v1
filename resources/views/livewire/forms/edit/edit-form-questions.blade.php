    ...
    <div wire:loading.class="disabled opacity-50 animate-pulse" class="grid grid-rows-12 min-h-screen">
                            ...
                            <div class="grid grid-cols-12  PX-1">
                                ...
                                <div  class=" col-span-12 mt-4" >
                                    <div class="felx justify-between space-x-[1px]">
                                        <a data-bs-toggle="tooltip"  data-bs-html="true" title="{{ __('main.formlogohint') }}">
                                            <svg   class="inline-block text-secondary_blue w-[18px] h-[18px]" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"></path>
                                            </svg>
                                        </a>
                                      <span class="whitespace-nowrap text-sm">{{ __('main.formlogo') }}</span>
                                    </div>
                            ...
                            <div class=" px-1 items-center " >
                                ...
                                <div class="grid w-full   mt-2   items-center"  >
                                    ...
                                    <div class="align-center" >
                                        ...
                                        <span class="{{ $current_form->active?"text-valid":"text-primary_red" }}  text-sm " >{{ $current_form->active?__('main.active'):__('main.inactive') }}</span>
                                    </div>
                                ...
                                <div class="grid w-full   mt-2   items-center"  >
                                    ...
                                    <div class="align-center" >
                                        <a data-bs-toggle="tooltip"  data-bs-html="true" title="{{ __('main.scoreformhint') }}">
                                                <svg   class="inline-block text-secondary_blue w-[18px] h-[18px]" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"></path>
                                                </svg>
                                        </a>
                                        <span class="text-black  text-sm " >{{ __('main.showthescore') }}</span>
                                    </div>
                                ...
                                <div class="grid w-full   mt-2   items-center"  >
                                    ...
                                    <div class="align-center" >
                                        <a data-bs-toggle="tooltip"  data-bs-html="true" title="{{ __('main.termsformhint') }}">
                                                <svg   class="inline-block text-secondary_blue w-[18px] h-[18px]" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"></path>
                                                </svg>
                                        </a>
                                        <span class="text-black  text-sm " >{{ __('main.audiencemustacceptourterms') }}</span>
                                    </div>
                                ...
                                <div class=" w-full  mt-2  grid grid-cols-12  justify-between  items-center"  >
                                    <div class=" grid col-span-12  items-center" >
                                        <span class="text-black text-sm  " >
                                            <a data-bs-toggle="tooltip"  data-bs-html="true" title="{{ __('main.expiryformhint') }}">
                                                <svg   class="inline-block text-secondary_blue w-[18px] h-[18px]" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"></path>
                                                </svg>
                                            </a>
                                            {{ __('main.setformasinactive') }}
                                        </span>
                                        <label class="ml-4 relative inline-flex items-center cursor-pointer">
                            ...
                            <div>
                                <div class="grid grid-cols-3 min-h-[80px] ">
                                    ...
                                    <div class="grid col-span-1 justify-center items-center my-2">
                                        ...
                                        <div><span class="text-xs text-center">{{ __('main.addquestion') }}</span></div>
                                    </div>
                                </div>
                                <div class="flex xs:grid justify-between border rounded-md  border-gray-200  mb-4">
                                    <ul class="flex  -mb-px" id="tabs-tab3"role="tablist" data-te-nav-ref>
                                        ...
                                        <li data-bs-toggle="tooltip"  data-bs-html="true" title="{{ __('main.addnewlanguage') }}"
                                    ...
                                    <div class="flex items-center">
                                     <div class="flex">
                                       <span class="text-sm">{{ __('main.questions') }}</span>
                                       <span class="text-sm {{ $this->current_subscribe->num_questions>count($current_questions)?"text-secondary_blue":"text-primary_red font-bold" }}  ">{{ count($current_questions).'/'.$this->current_subscribe->num_questions }}</span>
                                     </div>
                            ...
                            <div   class="overflow-y-auto  max-h-[80vh] min-h-[80vh]  "  >
                                ...
                                @if($current_message!=null)
                                        ...
                                        <li   class="list-none mr-1 ml-1 bg-gray-50 p-4 mt-2 hover:bg-slate-100 hover:border-2 hover:border-blue-300  rounded-lg  " >
                                            <div class="flex justify-between" >
                                                <div class="w-1/3 max-w-1/3">
                                                    <span class="mx-[1px] rounded bg-[#faebd7] text-black p-[2px] text-sm xs:text-xs">{{ __('main.startpage') }}</span>
                                                    <span class="mx-[1px] rounded bg-blue-300 p-[2px] text-sm xs:text-xs">{{ $current_language['name'] }}</span>
                                                </div>
                                                <div class="flex justify-between" >
                                            ...
                                            <div class="mt-8 xs:mt-2 flex justify-center">
                                    ...
                                    <li   class=" list-none mr-1 ml-1 bg-gray-50 p-4 mt-2 hover:bg-slate-100 hover:border-2 hover:border-blue-300  rounded-lg " >
                                        <div class="flex justify-between " >
                                            ...
                                            <div class="w-1/3 max-w-1/3">
                                                <span class="mx-[1px] rounded bg-[#faebd7] text-black p-[2px] text-sm xs:text-xs" >{{ __('main.termsconditions') }}</span>
                                                <span class="mx-[1px] rounded bg-blue-300 p-[2px] text-sm xs:text-xs">{{ $current_language['name'] }}</span>
                                            </div>
                                ...
                                {{-- end welcome message --}}
                                            ...
                                            <ul   class="{{ $local==$lan['code']?" opacity-100 ":"hidden opacity-0 " }}
                                                ...
                                                @foreach ($current_questions as $i=> $ques )
                                                            ...
                                                            <li wire:sortable.item="{{ $ques['id'] }}" wire:key="{{ $current_form_id }}-{{ $lan['code'] }}-{{ $ques['id'] }}"
                                                                ...
                                                                <div class="flex justify-between" >
                                                                    <div class="w-1/3 max-w-1/3">
                                                                        <span class="mx-[1px] rounded bg-[#faebd7] text-black p-[2px] text-sm xs:text-xs">{{ __('🆀 ') }}{{ $ques['type'] }}</span>
                                                                        <span class="mx-[1px] rounded text-sm xs:text-xs {{ $ques['optional']?"bg-green-100":"bg-red-100" }} p-[2px] "> {{ $ques['optional']?__('main.optional'):__('main.mandatory') }}</span>
                                                                        <span class="mx-[1px] rounded bg-blue-300 p-[2px] text-sm xs:text-xs">{{ $lan['name'] }}</span>
                                                                    </div>
                                                                    <div class="w-1/3 max-w-1/3 justify-center flex items-center" >
                                                                        <span class="text-blue-900 text-bold  text-lg font-bold " >{{ $i+1}}</span>
                                                                    </div>
                                                ...
                                                <div class="mt-4 mb-4  grid justify-center items-center" >
                                                    ...
                                                    <div>
                                                        <span class="text-black text-xs">{{ __('main.addquestion') }}</span>
                                                    </div>
                                    ...
                                    <li   class="list-none mr-1 ml-1 bg-gray-50 p-4 mt-2 hover:bg-slate-100 hover:border-2 hover:border-blue-300  rounded-lg  " >
                                        <div class="flex justify-between" >
                                            <div class="w-1/3 max-w-1/3">
                                                <span class="mx-[1px] rounded bg-[#faebd7] text-black p-[2px] text-sm xs:text-xs">{{ __('main.endpage') }}</span>
                                                <span class="mx-[1px] rounded bg-blue-300 p-[2px] text-sm xs:text-xs">{{ $current_language['name'] }}</span>
                                            </div>
                                            <div class="flex justify-between" >
        ...
        @endif
                ...
                <div  class="modal fade fixed top-0 left-0 z-[1055]  h-full w-full  " id="addquestion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                    <div class="xs:m-0 modal-dialog modal-dialog-centered  min-h-[calc(100%-1rem)] w-full max-w-[1250px] translate-y-[-50px] items-center  transition-all duration-10 ease-out-in min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:min-h-[calc(100%-3.5rem)]" role="document">
                      <div class="modal-content  w-full flex-col rounded-md border-none  bg-clip-padding text-current shadow-lg
                      outline-none ">
...
window.addEventListener('show-language-delete-confirmation', event => {
        ...
        const { value: accept } = await Swal.fire({
            text:translations.deletelangauge_message,
        input: 'checkbox',
        inputValue: 0,
        icon:'question',
        confirmButtonColor: '#dc2626',
...
window.addEventListener('show-terms-delete-confirmation', event => {
        ...
        const { value: accept } = await Swal.fire({
            ...
            showCancelButton: true,
            inputPlaceholder:translations.suredelete_terms,
            confirmButtonText:translations.delete,
            inputValidator: (result) => {
                return !result && translations.checkboxrequired
            }
...
function ShoweditTermsHint(){
    Swal.fire({
            ...
            confirmButtonColor:'#1277D1',
            cancelButtonText:`<h5 style='color:000000;border:0;box-shadow: none;'>${translations.ok}</h5>`,
