<x-jet-form-section submit="updatePassword">
    ...
    <x-slot  name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <div class="relative">
                <x-jet-input oninput="validatePasswordMatch()" id="password" pattern="^(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*])[A-Za-z\d!@#$%^&*]{8,}$" type="password" class="mt-1 block w-full" wire:model.defer="state.password" autocomplete="new-password" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <div class="relative">
            <x-jet-input oninput="validatePasswordMatch()" id="password_confirmation" type="password" class="mt-1 block w-full" wire:model.defer="state.password_confirmation" autocomplete="new-password" />
            <div   class="absolute  top-2 right-0 pr-3 flex items-center text-sm leading-5">
