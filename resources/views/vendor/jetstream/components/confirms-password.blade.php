@props(['title' => __('main.confirmpassword'), 'content' => __('main.confirmpasswordmessage'), 'button' => __('main.confirm')])
...
<x-jet-dialog-modal wire:model="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-jet-input type="password" class="mt-1 block w-3/4" placeholder="{{ __('main.password') }}"
