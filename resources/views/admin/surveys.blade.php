            ...
            <div class="2xl:col-span-7 xl:col-span-7 lg:col-span-7 md:col-span-7 sm:col-span-7 xs:col-span-7   pt-2 pl-[14px] pr-[14px] pb-2  xs:px-0   ">
                <div class="flex justify-start items-center mb-1">
                        ...
                        <div class="relative">
                            ...
                            " placeholder="Search in form id" required>
                ...
                <div id="forms_table"  class="w-full bg-white rounded-[0.5rem] overflow-auto max-h-[90vh]">
...
<script>
 var forms = {!! json_encode($forms->toArray(), JSON_HEX_TAG) !!};
    ...
    function searching(){
        ...
        else
        {
            forms.forEach(form => {
                    ...
                    InitialFormTable(new_Forms);
        }
    }
 // intial todo table
    function InitialFormTable(forms){



        forms_table=document.getElementById('forms_table');
        forms_table.innerHTML='';
        forms_table.innerHTML+=`
            <table  class="forms_table table-fixed  w-full rounded-xl   " >
                ...
                <thead class="h-10">
                    <tr class="  border-b-[1px] border-t-[1px] p-1  bg-secondary_blue text-white ">
                        ...
                        <th class="sticky top-0 px-4 py-2 bg-secondary_blue ml-1 mr-1 w-1/5 text-sm xs:text-xs text-center" >Owner ID</th>
                        <th class="sticky top-0 px-4 py-2 bg-secondary_blue ml-1 mr-1 w-1/5 text-sm xs:text-xs text-center" >Billing Name</th>
                        ...
                        <th class="sticky top-0 px-4 py-2 bg-secondary_blue ml-1 mr-1 w-1/5 text-sm xs:text-xs text-center" >Account Creation Date</th>
                        <th class="sticky top-0 px-4 py-2 bg-secondary_blue ml-1 mr-1 w-1/5 text-sm xs:text-xs text-center" >Last Update</th>
                    </tr>
                </thead>
                <tbody id="forms_table_body" class="bg-white " >
                </tbody>
            </table>

         `;
         forms_table_body=document.getElementById('forms_table_body');
         forms.forEach(function(form,i) {

            bg_custom=i%2==0?"bg-white":"bg-slate-50";
            forms_table_body.innerHTML+=`
                ...
                <td class="text-center ">
                    <div data-bs-toggle="tooltip"  data-bs-html="true" title="${ form.name }" class="hover:cursor-pointer min-h-[40px] max-h-[40px] overflow-hidden truncate flex justify-center items-center">
